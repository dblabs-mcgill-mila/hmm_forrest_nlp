...
tmp_dir = '/home/enning/scratch/forrest_group/tmp_data'

args = parser.parse_args()
subject = args.subject

try:
    inverse_path = os.path.join('/home/enning/scratch/datasets/forrest/',
...
try:
    maps_path = os.path.join('/home/enning/scratch/datasets/forrest/',
                             'aligned_data_fits', 'Smith_Harvard_Oxford_PCA')
    os.mkdir(maps_path)
...
schaefer_100_maps = nilearn.image.load_img(
    '/home/enning/projects/rrg-danilobz/enning/datasets/forrest/masks/Yeo 100 maps/schaefer_100_maps.nii_sub-{0}_to_bold3Tp2.nii.gz'
    .format(subject))
...
right_hippoAma = nilearn.image.load_img(
    f'/home/enning/scratch/datasets/forrest/masks/hippoAmygLabels/sub{subject}_rh.nii.gz'
)
left_hippoAma = nilearn.image.load_img(
    f'/home/enning/scratch/datasets/forrest/masks/hippoAmygLabels/sub{subject}_lh.nii.gz'
)
...
runs = []
paths = glob.glob(
    '/home/enning/scratch/datasets/forrest/studyforrest-data-aligned/sub-{0}/in_bold3Tp2/sub-{0}_task-avmovie_run-*_bold.nii.gz'
    .format(subject))
